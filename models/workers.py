...
class Workers(SQLModel, table=True):
    ...
    resignation_reason_id: Optional[int] = Field(default=None, foreign_key="resignablereasons.id", nullable=True)
    ...
    gender_id: Optional[int] = Field(default=None, foreign_key="genders.id", nullable=True)
    civil_status: Optional[str] = Field(default=None, nullable=True)
    ethnicity_id: Optional[int] = Field(default=None, foreign_key="ethnicity.id", nullable=True)
    birthdate: Optional[str] = Field(default=None, nullable=True)
    nationality: Optional[str] = Field(default=None, nullable=True)
    birthstate: Optional[int] = Field(default=None, foreign_key="states.id", nullable=True)
    birthcity: Optional[int] = Field(default=None, foreign_key="cities.id", nullable=True)
    ...
    # Address Information
    state_id: Optional[int] = Field(default=None, foreign_key="states.id", nullable=True)
    city_id: Optional[int] = Field(default=None, foreign_key="cities.id", nullable=True)
    neighborhood_id: Optional[int] = Field(default=None, foreign_key="neighborhoods.id", nullable=True)
    ...
    voter_title: Optional[str] = Field(default=None, nullable=True)
    voter_zone: Optional[str] = Field(default=None, nullable=True)
    voter_section: Optional[str] = Field(default=None, nullable=True)
    ...
    cnh_expiry_date: Optional[str] = Field(default=None, nullable=True)
    ...
    exposed_to_hazard: Optional[bool] = Field(default=None, nullable=True)
    
    # Test field (from original model)
    teste: Optional[str] = Field(default=None, nullable=True)
